...
import { ShoppingCart, Sparkles, ChevronDown, Info } from "lucide-react";
...
export default async function ShopPage() {
  ...
  {/* Gunakan komponen ini, jangan button biasa! */}
  <AddToCartButton product={product} />
</div>
              {/* Image dengan Badge Kategori */}
              ...
              <div className="p-8 flex-grow">
                ...
                {/* AI Recipe Accordion (Modern Style) */}
                <div className="mt-4">
